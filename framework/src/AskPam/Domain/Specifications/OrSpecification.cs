...
namespace AskPam.Domain.Specifications
{
    ...
    public class OrSpecification<T> : CompositeSpecification<T>
    {
        ...
        {
            BinaryExpression OrExpression = Expression.OrElse(Left.ToExpression().Body, Right.ToExpression().Body);

            return Expression.Lambda<Func<T, bool>>(OrExpression, Left.ToExpression().Parameters.Single());
        }
    }
}
