...
namespace AskPam.Domain.Specifications
{
    ...
    public class AndSpecification<T> : CompositeSpecification<T>
    {
        ...
        {
            BinaryExpression AndExpression = Expression.AndAlso(Left.ToExpression().Body, Right.ToExpression().Body);

            return Expression.Lambda<Func<T, bool>>(AndExpression, Left.ToExpression().Parameters.Single());
