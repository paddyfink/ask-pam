...
namespace AskPam.Crm.IntegratedTests.ConversationsController
{
    ...
    public class When_Assing_Conversation_To_User
    {
        readonly TestServerFixture _testServerFixture;
        
        public When_Assing_Conversation_To_User(TestServerFixture testServerFixture)
        {
        ...
        public async Task Should_Return_Ok()
        {
            ...
            var content = new StringContent(JsonConvert.SerializeObject(TestUsersBuilder.user1Id), Encoding.UTF8, "application/json");
            var response = await _testServerFixture.Client.PostAsync("api/conversations/1/assign", content);
