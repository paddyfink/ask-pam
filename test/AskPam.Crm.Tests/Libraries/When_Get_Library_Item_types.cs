...
namespace AskPam.Crm.IntegratedTests.LibrariesController
{
    ...
    public class When_Get_Library_Item_Types
    {
        readonly TestServerFixture _testServerFixture;


        public When_Get_Library_Item_Types(TestServerFixture testServerFixture)
        {
        ...
        {
            var response = await _testServerFixture.Client.GetAsync("api/Library/types");
