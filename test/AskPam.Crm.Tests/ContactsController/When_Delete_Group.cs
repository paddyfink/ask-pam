...
namespace AskPam.Crm.IntegratedTests.ContactsController
{
    ...
    public class When_Delete_Group 
    {
        readonly TestServerFixture _testServerFixture;


        public When_Delete_Group(TestServerFixture testServerFixture) 
        {
        ...
        public async Task Should_Return_NoContent()
        {
            ...
            var response = await _testServerFixture.Client.DeleteAsync("api/contacts/groups/2");
